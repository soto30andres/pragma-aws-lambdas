...
public class CreateClient implements RequestHandler<Map<String, Object>, ApiGatewayResponse>{   
	

    private static final Logger logger = LogManager.getLogger(CreateClient.class);
    ...
    public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context){
		...
		try{
			...
			clientSave.setId(UUID.randomUUID().toString());
			...
			responseBody = new ResponseClass("Se ha guardado el cliente con exito" , data);
		}catch(IOException e){
